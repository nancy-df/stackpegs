...
`7. Remove a tool with its hover "x" or the Delete key, "Clear" the canvas, or re-arrange with "Auto-layout". The top toolbar has Auto-layout, Download HTML and Clear.
